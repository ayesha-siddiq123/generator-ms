...
def students_event_data():
    ...
    df_snap.to_csv(output_path + '/' + state + '/' + program + '/students-event.data.csv', index=False)
def category_event_data():
    ...
    df_snap.to_csv(output_path + '/' + state + '/' + program + '/category-event.data.csv', index=False)
    return df_snap
...
def category_dimenstion_data():
    ...
    df_snap.to_csv(output_path + '/' + state+ '/' + program + '/category-dimension.data.csv',index=False)
